...
func run_bee() {
	...
	parametros := "UBICACIONES_HTTP_PORT=" + beego.AppConfig.String("httpport") + " UBICACIONES_CRUD__PGUSER=" + beego.AppConfig.String("PGuser") + " UBICACIONES_CRUD__PGPASS=" + beego.AppConfig.String("PGpass") + " UBICACIONES_CRUD__PGURLS=" + beego.AppConfig.String("PGurls") + " UBICACIONES_CRUD__PGDB=" + beego.AppConfig.String("PGdb") + " UBICACIONES_CRUD__SCHEMA=" + beego.AppConfig.String("PGschemas") + " bee run"
